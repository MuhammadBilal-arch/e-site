  ...
  const menu = (
    <Menu style={{ padding: "20px 20px" }}>
      {dropdownArray.map((item, index) => {
        return (
          <Menu.Item key={index} onClick={() => setdropdownItem(item.itemName)}>
            <Link className={classes.Link} to={item.itemName}>
              <CaretDownOutlined />
              {item.itemName}
            </Link>
          </Menu.Item>
    ...
    <div className={classes.navbar}>
      <div className={classes.container_logo}>
        ...
        <div className={classes.logo}>
          <img
            ...
            alt="Shop Logo"
            className="logostyle__LogoImage-sc-14em7a1-1 kkfezX"
          />
        </div>
        <div
          className={classes.DisplayDropDown}
          style={{
        ...
        >
          ...
          >
            <div className={classes.dropdownMenu}>
              <CaretDownOutlined />
              <span>{dropdownItem}</span> <CaretDownOutlined />
            </div>
          </Dropdown>
        </div>
      </div>
      {navState ? (
        <div className={classes.NavInput}>
          <Input
            style={{ maxWidth: "580px", minWidth: "350px" }}
            placeholder="Search your products from here"
            onChange={(e) => onSendSearch(e)}
            addonBefore={
              <SearchOutlined style={{ fontSize: "20px", margin: "auto 0" }} />
            }
          />
        </div>
      ) : null}
      <div className={classes.NavRoute}>
        <div>
        ...
        <div>Need Help</div>
        <div style={{ color: "rgb(0, 158, 127)" }}>English</div>
        <Button
          type="primary"
          size="large"
          style={{
      ...
      <div className={classes.NavResItem}>
        <div style={{ color: "rgb(0, 158, 127)" }}>English</div>
        <SearchOutlined style={{ fontSize: "22px", margin: "auto 0" }} />
      </div>
    </div>
  );
};
